...
export default function Settings() {
  ...
  return (
    <div className={`min-h-screen flex flex-col ${fonts.inconsolata.className} transition-transform`}>

      <nav className="flex justify-between items-center px-10 py-6">

        <div className={`text-2xl ${fonts.lilitaOne.className}`}>
          Tudor
        </div>
        ...
        <div className="flex items-center gap-10">
          ...
          <button onClick={() => router.back()}>
            <IoSettings className="text-xl rotate-180 hover:scale-110 transition-all cursor-pointer" />
          </button>
